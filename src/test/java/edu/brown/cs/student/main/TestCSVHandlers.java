...
//        System.out.println(response);
        assert response != null;
        assertEquals("LoadSuccessResponse[responseType=success, responseMap={result=[State, Data Type, Average Weekly Earnings, Number of Workers, Earnings Disparity, Employed Percent]\n" +
...
//        System.out.println(response);
        assert response != null;
        assertEquals("LoadSuccessResponse[responseType=success, responseMap={result=Row 2: [RI, Black, $770.26, 30424.80376, $0.73, 6%]\n" +
                "}]", response.toString());
        clientConnection.disconnect();
    }
