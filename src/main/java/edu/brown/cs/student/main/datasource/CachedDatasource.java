 ...
 * passing in a Datasource OR passing in a Datasource, the max size of the cache, and the
 * number of minutes the cache is meant to wait for each entry before clearing the entry.
 */
public class CachedDatasource {
    ...
    /**
     * Fetches the results of the query from the cache if available, otherwise sends a request to
     * the API.
     *
