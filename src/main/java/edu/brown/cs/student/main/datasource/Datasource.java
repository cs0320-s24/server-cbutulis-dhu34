...
public class Datasource {
     ...
     * @throws InterruptedException - Exception thrown when method is interupted
     */
    public String sendRequest(List<String> params) throws URISyntaxException, IOException,
        ...
        HttpResponse<String> sentCensusRequest =
                HttpClient.newBuilder()
                        .build()
                        .send(censusRequest, HttpResponse.BodyHandlers.ofString());
